...
static void draw_thread(void *arg)
{
    ...
    while (1)
    {
        printf("test1 thread is running\n");
        scanf("%s", str);
...
void page_test1_init(void)
{
    if (fb_nodeCreate(_name_test1, _path_page_menu,NULL ,pagetest1_draw, pagemenu_singal,NULL)) // 节点创建
    {
